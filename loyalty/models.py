...
#     changeMessage = models.CharField(max_length=255)
#     dateCreated = models.DateTimeField(auto_now_add=True)
#     dateUpdated = models.DateTimeField(auto_now=True)
#     passTemplate = models.ForeignKey(PassTemplate, on_delete=models.CASCADE)

# class PassTemplate(models.Model):
#     id = models.AutoField(primary_key=True)
#     backgroundColor = models.CharField(max_length=255)
#     logoUrl = models.CharField(max_length=255)
#     headerFields = models.ForeignKey(HeaderField, on_delete=models.CASCADE)